...
function create (opts) {
  ...
  Dat(opts.dir, opts, function (err, dat) {
    if (err && err.type === 'OpenError') return exit('Archive already exists. Use `dat sync` to resume sharing.')
