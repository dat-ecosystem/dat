...
module.exports = function() {
  ...
  that.blobs = function(blobs) {
    ...
    wrap.createReadStream = function() {
      var rs = blobs.createReadStream.apply(blobs, arguments)
      var track = through(read)
    ...
    wrap.createWriteStream = function() {
      var ws = blobs.createWriteStream.apply(blobs, arguments)
      var track = through(write)
