...
RestHandler.prototype.createRoutes = function() {
  ...
  router.addRoute("/_schemas", this.schemas.bind(this))
...
RestHandler.prototype.schemas = function(req, res) {
  this.json(res, this.dat.meta.schemas)
}
...
RestHandler.prototype.get = function(req, res, opts) {
  var self = this
  this.dat.storage.get(opts.id, url.parse(req.url, true).query || {}, function(err, json) {
