...
Replicator.prototype.createPullStream = function(remote, options) {
  ...
  var writeStream = this.dat.createWriteStream({ objects: true, overwrite: false, batchTime: 250 })
  return combiner(pullStream, writeStream)
}
...
Replicator.prototype.createPushStream = function(remote, options) {
  ...
  request(remote, {json: true}, function(err, resp, meta) {
