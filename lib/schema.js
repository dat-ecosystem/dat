...
Schema.prototype.update = function(cb) {
  var self = this
  this.db.get('schema', {valueEncoding:'utf-8', subset:'meta'}, function(err, proto) {
...
Schema.prototype._save = function(cb) {
  var self = this
  this.db.get('schema', {valueEncoding:'utf-8', subset:'meta'}, function(err, schema, version) {
    if (err && !err.notFound) return cb(err)
    self.db.put('schema', self.proto, {subset:'meta', version:version}, cb)
  })
}
